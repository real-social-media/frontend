...
const ForgotForm = ({ t, handleSubmit, loading, disabled, isValid, isValidating }) => {
  ...
  return (
    <View style={styling.root}>
      <View style={styling.input}>
        <Field
          testID="components/AuthSignin/Form/username"
          name="username"
      ...
      <View style={styling.input}>
        <DefaultButton
          testID="components/AuthSignin/Form/submit"
          label={t('Next')}
