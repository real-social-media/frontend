...
const ReactionsPreviewTemplate = ({ t, theme, post, user }) => {
  ...
  return (
    <TouchableOpacity
      onPress={navigationActions.navigatePostLikes(navigation, { postId: post.postId, userId: post.postedBy.userId })}
    >
      <View style={styling.root}>
        <View style={styling.row}>
          ...
          <View style={styling.row}>
            <Text style={styling.text}>{t('liked by')}</Text>
