 ...
 *
 */
const chatGetChatsRequest = (state, action) =>
  update(state, {
    chatGetChats: {
      status: { $set: 'loading' },
...
const chatGetChatsSuccess = (state, action) =>
  update(state, {
    chatGetChats: {
...
const chatGetChatsFailure = (state, action) =>
  update(state, {
    chatGetChats: {
      status: { $set: 'failure' },
      payload: { $set: action.payload.payload },
...
const chatGetChatsIdle = (state, action) =>
  update(state, {
    chatGetChats: {
      status: { $set: 'idle' },
      payload: { $set: action.payload.payload },
 ...
 *
 */
const chatGetChatRequest = (state, action) =>
  update(state, {
    chatGetChat: {
      status: { $set: 'loading' },
      payload: { $set: action.payload },
...
const chatGetChatSuccess = (state, action) =>
  update(state, {
    chatGetChat: {
      data: { $set: action.payload.data },
      status: { $set: 'success' },
...
const chatGetChatFailure = (state, action) =>
  update(state, {
    chatGetChat: {
      status: { $set: 'failure' },
      payload: { $set: action.payload.payload },
...
const chatGetChatIdle = (state, action) =>
  update(state, {
    chatGetChat: {
      status: { $set: 'idle' },
      payload: { $set: action.payload.payload },
 ...
 *
 */
const chatCreateDirectRequest = (state, action) =>
  update(state, {
    chatCreateDirect: {
      status: { $set: 'loading' },
      payload: { $set: action.payload },
...
const chatCreateDirectSuccess = (state, action) =>
  update(state, {
    chatCreateDirect: {
      data: { $set: action.payload.data },
      status: { $set: 'success' },
...
const chatCreateDirectFailure = (state, action) =>
  update(state, {
    chatCreateDirect: {
      status: { $set: 'failure' },
      payload: { $set: action.payload.payload },
...
const chatCreateDirectIdle = (state, action) =>
  update(state, {
    chatCreateDirect: {
      status: { $set: 'idle' },
      payload: { $set: action.payload.payload },
 ...
 *
 */
const chatAddMessageRequest = (state, action) =>
  update(state, {
    chatAddMessage: {
      status: { $set: 'loading' },
      payload: { $set: action.payload },
...
const chatAddMessageSuccess = (state, action) =>
  update(state, {
    chatAddMessage: {
      data: { $set: action.payload.data },
      status: { $set: 'success' },
...
const chatAddMessageFailure = (state, action) =>
  update(state, {
    chatAddMessage: {
      status: { $set: 'failure' },
      payload: { $set: action.payload.payload },
...
const chatAddMessageIdle = (state, action) =>
  update(state, {
    chatAddMessage: {
      status: { $set: 'idle' },
      payload: { $set: action.payload.payload },
 ...
 *
 */
const chatReportViewRequest = (state, action) =>
  update(state, {
    chatReportView: {
      status: { $set: 'loading' },
      payload: { $set: action.payload },
...
const chatReportViewSuccess = (state, action) =>
  update(state, {
    chatReportView: {
      data: { $set: action.payload.data },
      status: { $set: 'success' },
...
const chatReportViewFailure = (state, action) =>
  update(state, {
    chatReportView: {
      status: { $set: 'failure' },
      payload: { $set: action.payload.payload },
...
const chatReportViewIdle = (state, action) =>
  update(state, {
    chatReportView: {
      status: { $set: 'idle' },
      payload: { $set: action.payload.payload },
 ...
 *
 */
const chatDeleteMessageRequest = (state, action) =>
  update(state, {
    chatDeleteMessage: {
      status: { $set: 'loading' },
      payload: { $set: action.payload },
...
const chatDeleteMessageSuccess = (state, action) =>
  update(state, {
    chatDeleteMessage: {
      data: { $set: action.payload.data },
      status: { $set: 'success' },
...
const chatDeleteMessageFailure = (state, action) =>
  update(state, {
    chatDeleteMessage: {
      status: { $set: 'failure' },
      payload: { $set: action.payload.payload },
...
const chatDeleteMessageIdle = (state, action) =>
  update(state, {
    chatDeleteMessage: {
      status: { $set: 'idle' },
      payload: { $set: action.payload.payload },
 ...
 *
 */
const chatFlagMessageRequest = (state, action) =>
  update(state, {
    chatFlagMessage: {
      status: { $set: 'loading' },
      payload: { $set: action.payload },
...
const chatFlagMessageSuccess = (state, action) =>
  update(state, {
    chatFlagMessage: {
      data: { $set: action.payload.data },
      status: { $set: 'success' },
...
const chatFlagMessageFailure = (state, action) =>
  update(state, {
    chatFlagMessage: {
      status: { $set: 'failure' },
      payload: { $set: action.payload.payload },
...
const chatFlagMessageIdle = (state, action) =>
  update(state, {
    chatFlagMessage: {
      status: { $set: 'idle' },
      payload: { $set: action.payload.payload },
