...
export const chatGetChatSelector = (chatId) =>
  createDeepEqualSelector([chatGetChat(), entities()], (chatGetChat, entities) => {
...
export const chatGetChatsSelector = () =>
  createDeepEqualSelector([chatGetChats(), chatGetChat(), entities()], (chatGetChats, chatGetChat, entities) => {
...
export const chatCreateDirectSelector = (chatId) =>
  createDeepEqualSelector([chatCreateDirect(), entities()], (chatCreateDirect, entities) => {
    const denormalized = normalizer.denormalizeChatGet(chatId, entities)
