...
export const postsGetSelector = (userId) =>
...
export const postsGetUnreadCommentsSelector = () =>
  createDeepEqualSelector([postsGetUnreadComments(), entities()], (postsGetUnreadComments, entities) => {
...
export const postsGetArchivedSelector = () =>
  createDeepEqualSelector([postsGetArchived(), entities()], (postsGetArchived, entities) => {
...
export const postsFeedGetSelector = () =>
  createDeepEqualSelector(
...
export const postsSingleGetSelector = (postId) =>
  createDeepEqualSelector(
...
export const postsCommentsGetSelector = (postId) =>
  createDeepEqualSelector([postsCommentsGetCache(postId), entities()], (postsCommentsGetCache, entities) => {
...
export const postsViewsGetSelector = (postId) =>
  createDeepEqualSelector([postsViewsGetCache(postId), entities()], (postsViewsGetCache, entities) => {
...
export const postsLikesGetSelector = (postId) =>
  createDeepEqualSelector([postsLikesGetCache(postId), entities()], (postsLikesGetCache, entities) => {
...
export const postsGetTrendingPostsSelector = () =>
  createDeepEqualSelector([postsGetTrendingPosts(), entities()], (postsGetTrendingPosts, entities) => {
