 ...
 *
 */
const postsGetRequest = (state, action) =>
  update(state, {
    postsGetCache: {
...
const postsGetSuccess = (state, action) =>
  update(state, {
    postsGetCache: {
...
const postsGetFailure = (state, action) =>
  update(state, {
    postsGetCache: {
...
const postsGetIdle = (state, action) =>
  update(state, {
    postsGetCache: {
...
const postsGetMoreRequest = (state, action) =>
  update(state, {
    postsGetCache: {
...
const postsGetMoreSuccess = (state, action) =>
  update(state, {
    postsGetCache: {
 ...
 *
 */
const postsGetUnreadCommentsRequest = (state, action) =>
  update(state, {
    postsGetUnreadComments: {
      status: { $set: 'loading' },
...
const postsGetUnreadCommentsSuccess = (state, action) =>
  update(state, {
    postsGetUnreadComments: {
...
const postsGetUnreadCommentsFailure = (state, action) =>
  update(state, {
    postsGetUnreadComments: {
      status: { $set: 'failure' },
      payload: { $set: action.payload.payload },
...
const postsGetUnreadCommentsIdle = (state, action) =>
  update(state, {
    postsGetUnreadComments: {
      status: { $set: 'idle' },
      payload: { $set: action.payload.payload },
 ...
 *
 */
const postsViewsGetRequest = (state, action) =>
  update(state, {
    postsViewsGetCache: {
      $resourceCacheSetRequest: {
        ...action,
...
const postsViewsGetSuccess = (state, action) =>
  update(state, {
    postsViewsGetCache: {
      $resourceCacheSetSuccess: {
        ...action,
...
const postsViewsGetFailure = (state, action) =>
  update(state, {
    postsViewsGetCache: {
      $resourceCacheSetFailure: {
        ...action,
...
const postsViewsGetIdle = (state, action) =>
  update(state, {
    postsViewsGetCache: {
      $resourceCacheSetIdle: {
        ...action,
...
const postsViewsGetMoreRequest = (state, action) =>
  update(state, {
    postsViewsGetCache: {
      $resourceCachePushRequest: {
        ...action,
...
const postsViewsGetMoreSuccess = (state, action) =>
  update(state, {
    postsViewsGetCache: {
      $postsResourceCachePushSuccess: {
        ...action,
 ...
 *
 */
const postsLikesGetRequest = (state, action) =>
  update(state, {
    postsLikesGetCache: {
      $resourceCacheSetRequest: {
        ...action,
...
const postsLikesGetSuccess = (state, action) =>
  update(state, {
    postsLikesGetCache: {
      $resourceCacheSetSuccess: {
        ...action,
...
const postsLikesGetFailure = (state, action) =>
  update(state, {
    postsLikesGetCache: {
      $resourceCacheSetFailure: {
        ...action,
...
const postsLikesGetIdle = (state, action) =>
  update(state, {
    postsLikesGetIdle: {
      $resourceCacheSetIdle: {
        ...action,
 ...
 *
 */
const postsGetArchivedRequest = (state, action) =>
  update(state, {
    postsGetArchived: {
      status: { $set: 'loading' },
      payload: { $set: action.payload },
...
const postsGetArchivedSuccess = (state, action) =>
  update(state, {
    postsGetArchived: {
      data: { $set: action.payload.data },
      status: { $set: 'success' },
...
const postsGetArchivedFailure = (state) =>
  update(state, {
    postsGetArchived: {
      status: { $set: 'failure' },
    },
...
const postsGetArchivedIdle = (state) =>
  update(state, {
    postsGetArchived: {
 ...
 *
 */
const postsEditRequest = (state, action) =>
  update(state, {
    postsEdit: {
      status: { $set: 'loading' },
      payload: { $set: action.payload },
...
const postsEditSuccess = (state, action) =>
  update(state, {
    postsEdit: {
      data: { $set: action.payload.data },
      status: { $set: 'success' },
 ...
 *
 */
const postsDeleteRequest = (state, action) =>
  update(state, {
    postsDelete: {
      status: { $set: 'loading' },
      payload: { $set: action.payload },
...
const postsDeleteSuccess = (state, action) =>
  update(state, {
    postsDelete: {
      data: { $set: action.payload.data },
      status: { $set: 'success' },
...
const postsDeleteFailure = (state) =>
  update(state, {
    postsDelete: {
      status: { $set: 'failure' },
    },
 ...
 *
 */
const postsArchiveRequest = (state, action) =>
  update(state, {
    postsArchive: {
      status: { $set: 'loading' },
      payload: { $set: action.payload },
...
const postsArchiveSuccess = (state, action) =>
  update(state, {
    postsArchive: {
      data: { $set: action.payload.data },
      status: { $set: 'success' },
...
const postsArchiveFailure = (state) =>
  update(state, {
    postsArchive: {
      status: { $set: 'failure' },
    },
 ...
 *
 */
const postsRestoreArchivedRequest = (state, action) =>
  update(state, {
    postsRestoreArchived: {
      status: { $set: 'loading' },
      payload: { $set: action.payload },
...
const postsRestoreArchivedSuccess = (state, action) =>
  update(state, {
    postsRestoreArchived: {
      data: { $set: action.payload.data },
      status: { $set: 'success' },
...
const postsRestoreArchivedFailure = (state) =>
  update(state, {
    postsRestoreArchived: {
      status: { $set: 'failure' },
    },
...
const postsRestoreArchivedIdle = (state) =>
  update(state, {
    postsRestoreArchived: {
 ...
 *
 */
const postsFlagRequest = (state, action) =>
  update(state, {
    postsFlag: {
      status: { $set: 'loading' },
      payload: { $set: action.payload },
...
const postsFlagSuccess = (state, action) =>
  update(state, {
    postsFlag: {
      data: { $set: action.payload.data },
      status: { $set: 'success' },
 ...
 *
 */
const postsSingleGetRequest = (state, action) =>
  update(state, {
    postsSingleGet: {
      status: { $set: 'loading' },
      payload: { $set: action.payload },
...
const postsSingleGetSuccess = (state, action) =>
  update(state, {
    postsSingleGet: {
      data: { $set: action.payload.data },
      status: { $set: 'success' },
...
const postsSingleGetFailure = (state) =>
  update(state, {
    postsSingleGet: {
      status: { $set: 'failure' },
    },
...
const postsSingleGetIdle = (state) =>
  update(state, {
    postsSingleGet: {
 ...
 *
 */
const postsFeedGetRequest = (state, action) =>
  update(state, {
    postsFeedGet: {
      status: { $set: 'loading' },
      payload: { $set: action.payload },
...
const postsFeedGetSuccess = (state, action) =>
  update(state, {
    postsFeedGet: {
      data: { $set: action.payload.data },
      status: { $set: 'success' },
...
const postsFeedGetFailure = (state) =>
  update(state, {
    postsFeedGet: {
      status: { $set: 'failure' },
    },
...
const postsFeedGetMoreRequest = (state, action) =>
  update(state, {
    postsFeedGet: {
      status: { $set: 'loading' },
      payload: { $set: action.payload },
...
const postsFeedGetMoreSuccess = (state, action) =>
  update(state, {
    postsFeedGet: {
 ...
 *
 */
const postsCreateRequest = (state, action) =>
  update(state, {
    postsCreate: {
      status: { $set: 'loading' },
      payload: { $set: action.payload },
...
const postsCreateSuccess = (state, action) =>
  update(state, {
    postsCreate: {
      data: { $set: action.payload.data },
      status: { $set: 'success' },
...
const postsCreateFailure = (state, action) =>
  update(state, {
    postsCreate: {
      status: { $set: 'failure' },
    },
...
const postsCreateIdle = (state, action) =>
  update(state, {
    postsCreate: {
...
const postsCreateProgress = (state, action) =>
  update(state, {
    postsCreate: {
      status: { $set: 'loading' },
      meta: { $set: action.payload.meta },
 ...
 *
 */
const postsOnymouslyLikeRequest = (state, action) =>
  update(state, {
    postsOnymouslyLike: {
      status: { $set: 'loading' },
      payload: { $set: action.payload },
...
const postsOnymouslyLikeSuccess = (state, action) =>
  update(state, {
    postsOnymouslyLike: {
      data: { $set: action.payload.data },
      status: { $set: 'success' },
...
const postsOnymouslyLikeFailure = (state) =>
  update(state, {
    postsOnymouslyLike: {
      status: { $set: 'failure' },
    },
...
const postsOnymouslyLikeIdle = (state) =>
  update(state, {
    postsOnymouslyLike: {
 ...
 *
 */
const postsDislikeRequest = (state, action) =>
  update(state, {
    postsDislike: {
      status: { $set: 'loading' },
      payload: { $set: action.payload },
...
const postsDislikeSuccess = (state, action) =>
  update(state, {
    postsDislike: {
      data: { $set: action.payload.data },
      status: { $set: 'success' },
...
const postsDislikeFailure = (state) =>
  update(state, {
    postsDislike: {
      status: { $set: 'failure' },
    },
 ...
 *
 */
const postsShareRequest = (state, action) =>
  update(state, {
    postsShare: {
      status: { $set: 'loading' },
      payload: { $set: action.payload },
...
const postsShareSuccess = (state, action) =>
  update(state, {
    postsShare: {
      data: { $set: action.payload.data },
      status: { $set: 'success' },
 ...
 *
 */
const postsReportPostViewsRequest = (state, action) =>
  update(state, {
    postsReportPostViews: {
      status: { $set: 'loading' },
      payload: { $set: action.payload },
...
const postsReportPostViewsSuccess = (state, action) =>
  update(state, {
    postsReportPostViews: {
      data: { $set: action.payload.data },
      status: { $set: 'success' },
...
const postsReportPostViewsFailure = (state) =>
  update(state, {
    postsReportPostViews: {
      status: { $set: 'failure' },
    },
...
const postsReportPostViewsIdle = (state) =>
  update(state, {
    postsReportPostViews: {
 ...
 *
 */
const postsGetTrendingPostsRequest = (state, action) =>
  update(state, {
    postsGetTrendingPosts: {
      status: { $set: 'loading' },
      payload: { $set: action.payload },
...
const postsGetTrendingPostsSuccess = (state, action) =>
  update(state, {
    postsGetTrendingPosts: {
      data: { $set: action.payload.data },
      status: { $set: 'success' },
...
const postsGetTrendingPostsFailure = (state) =>
  update(state, {
    postsGetTrendingPosts: {
      status: { $set: 'failure' },
    },
...
const postsGetTrendingPostsIdle = (state) =>
  update(state, {
    postsGetTrendingPosts: {
...
const postsGetTrendingPostsMoreRequest = (state, action) =>
  update(state, {
    postsGetTrendingPosts: {
      status: { $set: 'loading' },
      payload: { $set: action.payload },
...
const postsGetTrendingPostsMoreSuccess = (state, action) =>
  update(state, {
    postsGetTrendingPosts: {
      data: { $push: action.payload.data },
      status: { $set: 'success' },
 ...
 *
 */
const postsCommentsGetRequest = (state, action) =>
  update(state, {
    postsCommentsGetCache: {
      $resourceCacheSetRequest: {
        ...action,
...
const postsCommentsGetSuccess = (state, action) =>
  update(state, {
    postsCommentsGetCache: {
      $resourceCacheSetSuccess: {
        ...action,
...
const postsCommentsGetFailure = (state, action) =>
  update(state, {
    postsCommentsGetCache: {
      $resourceCacheSetFailure: {
        ...action,
...
const postsCommentsGetIdle = (state, action) =>
  update(state, {
    postsCommentsGetCache: {
      $resourceCacheSetIdle: {
        ...action,
 ...
 *
 */
const commentsAddRequest = (state, action) =>
  update(state, {
    commentsAdd: {
      status: { $set: 'loading' },
      payload: { $set: action.payload },
...
const commentsAddSuccess = (state, action) =>
  update(state, {
    commentsAdd: {
      data: { $set: action.payload.data },
      status: { $set: 'success' },
...
const commentsAddFailure = (state) =>
  update(state, {
    commentsAdd: {
      status: { $set: 'failure' },
    },
 ...
 *
 */
const commentsDeleteRequest = (state, action) =>
  update(state, {
    commentsDelete: {
      status: { $set: 'loading' },
      payload: { $set: action.payload },
...
const commentsDeleteSuccess = (state, action) =>
  update(state, {
    commentsDelete: {
      data: { $set: action.payload.data },
      status: { $set: 'success' },
...
const commentsDeleteFailure = (state) =>
  update(state, {
    commentsDelete: {
      status: { $set: 'failure' },
    },
...
const commentsDeleteIdle = (state) =>
  update(state, {
    commentsDelete: {
 ...
 *
 */
const commentsFlagRequest = (state, action) =>
  update(state, {
    commentsFlag: {
      status: { $set: 'loading' },
      payload: { $set: action.payload },
...
const commentsFlagSuccess = (state, action) =>
  update(state, {
    commentsFlag: {
      data: { $set: action.payload.data },
      status: { $set: 'success' },
...
const commentsFlagFailure = (state) =>
  update(state, {
    commentsFlag: {
      status: { $set: 'failure' },
    },
