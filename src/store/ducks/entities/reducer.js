...
const entitiesUsersMerge = (state, action) =>
  update(state, {
    users: {
...
const entitiesAlbumsMerge = (state, action) =>
  update(state, {
    albums: {
...
const entitiesPostsMerge = (state, action) =>
  update(state, {
    posts: {
...
const entitiesCommentsMerge = (state, action) =>
  update(state, {
    comments: {
...
const entitiesImagesMerge = (state, action) =>
  update(state, {
    images: {
...
const entitiesChatsMerge = (state, action) =>
  update(state, {
    chats: {
...
const entitiesMessagesMerge = (state, action) =>
  update(state, {
    messages: {
