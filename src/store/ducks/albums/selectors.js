...
export const albumsGetSelector = (userId) =>
  createDeepEqualSelector([albumsGetCache(userId), entities()], (albumsGetCache, entities) => {
...
export const albumsSingleGetSelector = (albumId) =>
  createDeepEqualSelector([albumsSingleGet(), entities()], (albumsSingleGet, entities) => {
...
export const albumsPostsGetSelector = (albumId) =>
  createDeepEqualSelector([albumsPostsGetCache(albumId), entities()], (albumsPostsGetCache, entities) => {
