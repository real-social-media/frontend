...
const themeFetchSuccess = (state, action) =>
  update(state, {
    themeFetch: {
 ...
 *
 */
const themePreviewRequest = (state) =>
  update(state, {
    themePreview: {
      status: { $set: 'loading' },
    },
...
const themePreviewSuccess = (state, action) =>
  update(state, {
    themePreview: {
      data: { $set: action.payload.data },
      status: { $set: 'success' },
...
const themePreviewFailure = (state) =>
  update(state, {
    themePreview: {
      status: { $set: 'failure' },
    },
