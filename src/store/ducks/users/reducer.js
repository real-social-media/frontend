 ...
 *
 */
const usersSearchRequest = (state, action) =>
  update(state, {
    usersSearch: {
      status: { $set: 'loading' },
...
const usersSearchSuccess = (state, action) =>
  update(state, {
    usersSearch: {
...
const usersSearchFailure = (state, action) =>
  update(state, {
    usersSearch: {
      status: { $set: 'failure' },
 ...
 *
 */
const usersDeleteRequest = (state, action) =>
  update(state, {
    usersDelete: {
      status: { $set: 'loading' },
      payload: { $set: action.payload },
 ...
 *
 */
const usersGetFollowedUsersWithStoriesRequest = (state, action) =>
  update(state, {
    usersGetFollowedUsersWithStories: {
      status: { $set: 'loading' },
      payload: { $set: action.payload },
...
const usersGetFollowedUsersWithStoriesSuccess = (state, action) =>
  update(state, {
    usersGetFollowedUsersWithStories: {
      data: { $set: action.payload.data },
      status: { $set: 'success' },
...
const usersGetFollowedUsersWithStoriesFailure = (state, action) =>
  update(state, {
    usersGetFollowedUsersWithStories: {
      status: { $set: 'failure' },
      error: { $set: action.payload.message },
...
const usersGetFollowedUsersWithStoriesIdle = (state) =>
  update(state, {
    usersGetFollowedUsersWithStories: {
 ...
 *
 */
const usersGetFollowedUsersRequest = (state, action) =>
  update(state, {
    usersGetFollowedUsersCache: {
...
const usersGetFollowedUsersSuccess = (state, action) =>
  update(state, {
    usersGetFollowedUsersCache: {
...
const usersGetFollowedUsersFailure = (state, action) =>
  update(state, {
    usersGetFollowedUsersCache: {
...
const usersGetFollowedUsersIdle = (state, action) =>
  update(state, {
    usersGetFollowedUsersCache: {
 ...
 *
 */
const usersGetFollowerUsersRequest = (state, action) =>
  update(state, {
    usersGetFollowerUsersCache: {
      $resourceCacheSetRequest: {
        ...action,
...
const usersGetFollowerUsersSuccess = (state, action) =>
  update(state, {
    usersGetFollowerUsersCache: {
      $resourceCacheSetSuccess: {
        ...action,
...
const usersGetFollowerUsersFailure = (state, action) =>
  update(state, {
    usersGetFollowerUsersCache: {
      $resourceCacheSetFailure: {
        ...action,
...
const usersGetFollowerUsersIdle = (state, action) =>
  update(state, {
    usersGetFollowerUsersCache: {
      $resourceCacheSetIdle: {
        ...action,
 ...
 *
 */
const usersGetPendingFollowersRequest = (state, action) =>
  update(state, {
    usersGetPendingFollowers: {
      status: { $set: 'loading' },
      payload: { $set: action.payload },
...
const usersGetPendingFollowersSuccess = (state, action) =>
  update(state, {
    usersGetPendingFollowers: {
      data: { $set: action.payload.data },
      status: { $set: 'success' },
...
const usersGetPendingFollowersFailure = (state, action) =>
  update(state, {
    usersGetPendingFollowers: {
      status: { $set: 'failure' },
      error: { $set: action.payload.message },
...
const usersGetPendingFollowersIdle = (state) =>
  update(state, {
    usersGetPendingFollowers: {
 ...
 *
 */
const usersFollowRequest = (state, action) =>
  update(state, {
    usersFollow: {
      status: { $set: 'loading' },
      payload: { $set: action.payload },
...
const usersFollowSuccess = (state, action) =>
  update(state, {
    usersFollow: {
      data: { $set: action.payload.data },
      status: { $set: 'success' },
...
const usersFollowFailure = (state, action) =>
  update(state, {
    usersFollow: {
      status: { $set: 'failure' },
      error: { $set: action.payload.message },
 ...
 *
 */
const usersUnfollowRequest = (state, action) =>
  update(state, {
    usersUnfollow: {
      status: { $set: 'loading' },
      payload: { $set: action.payload },
...
const usersUnfollowSuccess = (state, action) =>
  update(state, {
    usersUnfollow: {
      data: { $set: action.payload.data },
      status: { $set: 'success' },
...
const usersUnfollowFailure = (state, action) =>
  update(state, {
    usersUnfollow: {
      status: { $set: 'failure' },
      error: { $set: action.payload.message },
 ...
 *
 */
const usersAcceptFollowerUserRequest = (state, action) =>
  update(state, {
    usersAcceptFollowerUser: {
      status: { $set: 'loading' },
      payload: { $set: action.payload },
...
const usersAcceptFollowerUserSuccess = (state, action) =>
  update(state, {
    usersAcceptFollowerUser: {
      data: { $set: action.payload.data },
      status: { $set: 'success' },
...
const usersAcceptFollowerUserFailure = (state, action) =>
  update(state, {
    usersAcceptFollowerUser: {
      status: { $set: 'failure' },
      error: { $set: action.payload.message },
...
const usersAcceptFollowerUserIdle = (state) =>
  update(state, {
    usersAcceptFollowerUser: {
 ...
 *
 */
const usersBlockRequest = (state, action) =>
  update(state, {
    usersBlock: {
      status: { $set: 'loading' },
      payload: { $set: action.payload },
...
const usersBlockSuccess = (state, action) =>
  update(state, {
    usersBlock: {
      data: { $set: action.payload.data },
      status: { $set: 'success' },
...
const usersBlockFailure = (state, action) =>
  update(state, {
    usersBlock: {
      status: { $set: 'failure' },
      error: { $set: action.payload.message },
 ...
 *
 */
const usersUnblockRequest = (state, action) =>
  update(state, {
    usersUnblock: {
      status: { $set: 'loading' },
      payload: { $set: action.payload },
...
const usersUnblockSuccess = (state, action) =>
  update(state, {
    usersUnblock: {
      data: { $set: action.payload.data },
      status: { $set: 'success' },
...
const usersUnblockFailure = (state, action) =>
  update(state, {
    usersUnblock: {
      status: { $set: 'failure' },
      error: { $set: action.payload.message },
 ...
 *
 */
const usersGetProfileRequest = (state, action) =>
  update(state, {
    usersGetProfile: {
      status: { $set: 'loading' },
      payload: { $set: action.payload },
...
const usersGetProfileSuccess = (state, action) =>
  update(state, {
    usersGetProfile: {
      data: { $set: action.payload.data },
      status: { $set: 'success' },
...
const usersGetProfileFailure = (state, action) =>
  update(state, {
    usersGetProfile: {
      status: { $set: 'failure' },
      error: { $set: action.payload.message },
...
const usersGetProfileIdle = (state) =>
  update(state, {
    usersGetProfile: {
 ...
 *
 */
const usersGetProfileSelfRequest = (state, action) =>
  update(state, {
    usersGetProfileSelf: {
      status: { $set: 'loading' },
      payload: { $set: action.payload },
...
const usersGetProfileSelfSuccess = (state, action) =>
  update(state, {
    usersGetProfileSelf: {
      data: { $set: action.payload.data },
      status: { $set: 'success' },
...
const usersGetProfileSelfFailure = (state, action) =>
  update(state, {
    usersGetProfileSelf: {
      status: { $set: 'failure' },
      error: { $set: action.payload.message },
...
const usersGetProfileSelfIdle = (state) =>
  update(state, {
    usersGetProfileSelf: {
 ...
 *
 */
const usersEditProfileRequest = (state, action) =>
  update(state, {
    usersEditProfile: {
      status: { $set: 'loading' },
      payload: { $set: action.payload },
...
const usersEditProfileSuccess = (state, action) =>
  update(state, {
    usersEditProfile: {
      data: { $set: action.payload.data },
      status: { $set: 'success' },
...
const usersEditProfileFailure = (state, action) =>
  update(state, {
    usersEditProfile: {
      status: { $set: 'failure' },
      error: { $set: action.payload.message },
...
const usersEditProfileIdle = (state) =>
  update(state, {
    usersEditProfile: {
 ...
 *
 */
const usersImagePostsGetRequest = (state, action) =>
  update(state, {
    usersImagePostsGet: {
      status: { $set: 'loading' },
      payload: { $set: action.payload },
...
const usersImagePostsGetSuccess = (state, action) =>
  update(state, {
    usersImagePostsGet: {
      data: { $set: action.payload.data },
      status: { $set: 'success' },
...
const usersImagePostsGetFailure = (state, action) =>
  update(state, {
    usersImagePostsGet: {
      status: { $set: 'failure' },
      error: { $set: action.payload.message },
...
const usersImagePostsGetIdle = (state) =>
  update(state, {
    usersImagePostsGet: {
 ...
 *
 */
const usersGetTrendingUsersRequest = (state, action) =>
  update(state, {
    usersGetTrendingUsers: {
      status: { $set: 'loading' },
      payload: { $set: action.payload },
...
const usersGetTrendingUsersSuccess = (state, action) =>
  update(state, {
    usersGetTrendingUsers: {
      data: { $set: action.payload.data },
      status: { $set: 'success' },
...
const usersGetTrendingUsersFailure = (state, action) =>
  update(state, {
    usersGetTrendingUsers: {
      status: { $set: 'failure' },
      error: { $set: action.payload.message },
...
const usersGetTrendingUsersIdle = (state) =>
  update(state, {
    usersGetTrendingUsers: {
 ...
 *
 */
const usersGetCardsRequest = (state, action) =>
  update(state, {
    usersGetCards: {
      status: { $set: 'loading' },
      payload: { $set: action.payload },
...
const usersGetCardsSuccess = (state, action) =>
  update(state, {
    usersGetCards: {
      data: { $set: action.payload.data },
      status: { $set: 'success' },
...
const usersGetCardsFailure = (state, action) =>
  update(state, {
    usersGetCards: {
      status: { $set: 'failure' },
      error: { $set: action.payload.message },
...
const usersGetCardsOptimistic = (state, action) =>
  update(state, {
    usersGetCards: {
 ...
 *
 */
const usersDeleteCardRequest = (state, action) =>
  update(state, {
    usersDeleteCard: {
      status: { $set: 'loading' },
      payload: { $set: action.payload },
...
const usersDeleteCardSuccess = (state, action) =>
  update(state, {
    usersDeleteCard: {
      data: { $set: action.payload.data },
      status: { $set: 'success' },
...
const usersDeleteCardFailure = (state, action) =>
  update(state, {
    usersDeleteCard: {
      status: { $set: 'failure' },
      error: { $set: action.payload.message },
...
const usersDeleteCardIdle = (state) =>
  update(state, {
    usersDeleteCard: {
      data: { $set: initialState.usersGetCards.data },
      error: { $set: initialState.usersGetCards.error },
 ...
 *
 */
const usersSetApnsTokenRequest = (state, action) =>
  update(state, {
    usersSetApnsToken: {
      status: { $set: 'loading' },
      payload: { $set: action.payload },
...
const usersSetApnsTokenSuccess = (state, action) =>
  update(state, {
    usersSetApnsToken: {
      data: { $set: action.payload.data },
      status: { $set: 'success' },
...
const usersSetApnsTokenFailure = (state, action) =>
  update(state, {
    usersSetApnsToken: {
      status: { $set: 'failure' },
      error: { $set: action.payload.message },
...
const usersSetApnsTokenIdle = (state) =>
  update(state, {
    usersSetApnsToken: {
