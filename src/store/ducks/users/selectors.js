...
export const usersGetProfileSelector = (userId) =>
  createDeepEqualSelector([usersGetProfile(), entities()], (usersGetProfile, entities) => {
...
export const usersGetProfileSelfSelector = () =>
  createDeepEqualSelector([authUser(), entities()], (authUser, entities) => {
...
export const usersGetFollowedUsersSelector = (userId) =>
  createDeepEqualSelector(
    [usersGetFollowedUsersCacheUser(userId), entities()],
    (usersGetFollowedUsersCacheUser, entities) => {
      const users = path(['data'])(usersGetFollowedUsersCacheUser)
        ? usersGetFollowedUsersCacheUser
        : initialState.usersGetFollowedUsers
...
export const usersGetFollowerUsersSelector = (userId) =>
  createDeepEqualSelector(
    [usersGetFollowerUsersCacheUser(userId), entities()],
    (usersGetFollowerUsersCacheUser, entities) => {
      const users = path(['data'])(usersGetFollowerUsersCacheUser)
        ? usersGetFollowerUsersCacheUser
        : initialState.usersGetFollowerUsers
      const denormalized = normalizer.denormalizeUsersGet(users.data, entities)
      return assocPath(['data'], denormalized)(users)
    },
  )
...
export const usersGetTrendingUsersSelector = () =>
  createDeepEqualSelector([usersGetTrendingUsers(), entities()], (usersGetTrendingUsers, entities) => {
...
export const usersSearchSelector = () =>
  createDeepEqualSelector([usersSearch(), entities()], (usersSearch, entities) => {
...
export const usersGetFollowedUsersWithStoriesSelector = () =>
  createDeepEqualSelector(
...
export const usersGetPendingFollowersSelector = () =>
  createDeepEqualSelector([usersGetPendingFollowers(), entities()], (usersGetPendingFollowers, entities) => {
...
export const usersImagePostsGetSelector = () =>
  createDeepEqualSelector([usersImagePostsGet(), entities()], (usersImagePostsGet, entities) => {
